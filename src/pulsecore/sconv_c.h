#ifndef foosconv_chfoo
#define foosconv_chfoo
...
void pa_sconv_float32be_to_s16ne(unsigned n, const float *a, int16_t *b);
void pa_sconv_float32be_from_s16ne(unsigned n, const int16_t *a, float *b);
