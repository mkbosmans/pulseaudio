...
void pa_convert_func_init_sse(pa_cpu_x86_flag_t flags) {
    ...
    if (flags & PA_CPU_X86_SSE2) {
        ...
        pa_set_convert_to_s16ne_function(PA_SAMPLE_FLOAT32NE, (pa_convert_func_t) sconv_s16le_from_f32ne_sse2);
    } else {
        ...
        pa_set_convert_to_s16ne_function(PA_SAMPLE_FLOAT32NE, (pa_convert_func_t) sconv_s16le_from_f32ne_sse);
    }
